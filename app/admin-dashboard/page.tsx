...
import { Users, PlusCircle, BarChart3, Activity, UserCheck, Trash2, Loader2 } from 'lucide-react';
            ...
            {students.map((s, idx) => (
              <li
                ...
                className={`flex justify-between items-center border-l-4 border-purple-300 pl-4 py-2 rounded-lg transition hover:bg-gradient-to-r ${
                  idx % 2 === 0 ? 'from-purple-50 via-pink-50 to-yellow-50' : 'from-green-50 via-blue-50 to-indigo-50'
                }`}
              >
                <div>
